...
public class LoginScreen extends JFrame {
    ...
    public LoginScreen() {
        ...
        formContainer.setBackground(new Color(0x2D2D2D)); // dark gray background
        ...
        // Adding components
        gbc.gridx = 0; gbc.gridy = 0; formContainer.add(loginAsLabel, gbc);
        gbc.gridx = 1; formContainer.add(roleBox, gbc);

        gbc.gridx = 0; gbc.gridy = 1; formContainer.add(usernameLabel, gbc);
        gbc.gridx = 1; formContainer.add(usernameField, gbc);

        gbc.gridx = 0; gbc.gridy = 2; formContainer.add(passwordLabel, gbc);
        gbc.gridx = 1; formContainer.add(passwordField, gbc);
